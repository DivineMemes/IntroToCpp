...
int main()
{
	...
	//mixtape
	std::cout << "The Following is a tracklist for my mixtape. " << std::endl;
	std::cout << "Track_1 (Memes.exe)" << std::endl;
	std::cout << "Track_2 (Memes.txt)" << std::endl;
	std::cout << "Track_3 (Memes.cpp)" << std::endl;
	system("pause");
	//When "i" is less than 5 it increases and prints out
	for (int i = 0; i <= 5; i++)
		std::cout << i << std::endl;
	
	system("pause");
	//When 0 is less than 5 it increases and prints out
	for(int v = 0; v <= 5; v++)
	{ 
		std::cout << v << std::endl;
